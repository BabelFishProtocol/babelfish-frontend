...
const BRIDGED_ADDRESSES = {
  [destinationTokenEnum.ETHs]: {
    BasketManager: {
      address: IS_LOCALNET ? '0xe982E462b094850F12AF94d21D470e21bE9D0E9C' : '0x24d3AC480Fc442Ee5110edd105544d8Bc9f1D023',
      abi: BasketManagerABI as any,
    },
    BasketManagerNew: {
      address: IS_LOCALNET ? '0x7C728214be9A0049e6a86f2137ec61030D0AA964' : '0x0941F377eD05D2269675aFE3F13cA873b78C3213',
      abi: BasketManagerV3ABI as any,
    },
    MassetV3: {
      address: IS_LOCALNET ? '0x254dffcd3277C0b1660F6d42EFbB754edaBAbC2B' : '0x1101dCA11f9d361d56A7BA782e37e638B8F10bCE',
      abi: MassetV3ABI as any,
    },
  },
  [destinationTokenEnum.XUSD]: {
    BasketManager: {
      address: IS_LOCALNET ? '0x26b4AFb60d6C903165150C6F0AA14F8016bE4aec' : '0x79a9B331D15C560A9c144E7B7bdfeB683A25317e',
      abi: BasketManagerABI as any,
    },
    BasketManagerNew: {
      address: IS_LOCALNET ? '0xf19A2A01B70519f67ADb309a994Ec8c69A967E8b' : '0x0805ccCAa1e44EFFa98e409675176F2e83AFff19',
      abi: BasketManagerV3ABI as any,
    },
    MassetV3: {
      address: IS_LOCALNET ? '0x67B5656d60a809915323Bf2C40A8bEF15A152e3e' : '0x2F891EfDC0c876ce5e9a2EbD35afb272F15A2Fd2',
      abi: MassetV3ABI as any,
    },
  },
  [destinationTokenEnum.BNBs]: {
    BasketManager: {
      address: IS_LOCALNET ? '0xFC628dd79137395F3C9744e33b1c5DE554D94882' : '0xE77078b15EC3fb481a4e44CE2A464Ae8d2aC115e',
      abi: BasketManagerABI as any,
    },
    BasketManagerNew: {
      address: IS_LOCALNET ? '0x9e90054F4B6730cffAf1E6f6ea10e1bF9dD26dbb' : '0x22eeb4F794d90fFa014996Ffb30Ca2295Ca2AD65',
      abi: BasketManagerV3ABI as any,
    },
    MassetV3: {
      address: IS_LOCALNET ? '0xA94B7f0465E98609391C623d0560C5720a3f2D33' : '0x31c7155C560c364C103A4aCFdB860803Ce93709d',
      abi: MassetV3ABI as any,
    },
  },
} as const;
