...
export const destinationTokensCatalog = {
  [destinationTokenEnum.XUSD]: {
    symbol: 'XUSD',
    address: IS_MAINNET ? '0xb5999795BE0EbB5bAb23144AA5FD6A02D080299F' : '0x152123ec3D9fe2Cf57aBc09917C1ba51324EA8dE',
  },
...
const offlineTokenAddresses = IS_MAINNET ? ({
  ...
  'USDTes': ['0xD9665EA8F5fF70Cf97E1b1Cd1B4Cd0317b0976e8', '0xdac17f958d2ee523a2206206994597c13d831ec7',6],
  'USDTbs': ['0xFf4299bCA0313C20A61dc5eD597739743BEf3f6d', '0x55d398326f99059ff775485246999027b3197955',18],
  'rUSDT': ['0xef213441A85dF4d7ACbDaE0Cf78004e1E486bB96',,18],
  'USDCes': ['0x8D1f7CbC6391D95E2774380e80A666FEbf655D6b', '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48',6],
  'USDCbs': ['0x91EDceE9567cd5612c9DEDeaAE24D5e574820af1', '0x8ac76a51cc950d9822d68b83fe1ad97b32cd580d',18],
  'DAIes': ['0x1A37c482465e78E6DAbE1Ec77B9a24D4236D2A11', '0x6b175474e89094c44da98b954eedeac495271d0f',18],
  'DAIbs': ['0x6A42Ff12215a90f50866A5cE43A9c9C870116e76', '0x1af3f329e8be154074d8769d1ffa4ee058b1dbc3',18],
  'BUSDbs': ['0x61e9604e31a736129d7f5C58964c75935b2d80D6', '0xe9e7cea3dedca5984780bafc599bd69add087d56',18],
}) : ({
  'DOC': ['0xCB46c0ddc60D18eFEB0E586C17Af6ea36452Dae0',,18],
  'rDOC': ['0xC3De9F38581f83e281f260d0DdbaAc0e102ff9F8',,18],
  'USDTes': ['0x10c5a7930fc417e728574e334b1488b7895c4b81', '0xff364ffa4962cb172203a5be01d17cf3fef02419',6],
  'bsUSDT': ['0x43bc3f0ffff6c9bbf3c2eafe464c314d43f561de', '0x268e3bf855cbcdf8fe31ba3557a554ab2283351f',18],
  'USDT': ['0x4d5a316d23ebe168d8f887b4447bf8dbfa4901cc',,18], // rUSDT
  'USDCes': ['0xcc8eec21ae75f1a2de4ac7b32a7de888a45cf859', '0x4C68058992b8aD1243eE23A5923023C0e15Cf43F',6],
  'bsUSDC': ['0x3e2cf87e7ff4048a57f9cdde9368c9f4bfb43adf', '0x0b654c687dc8b828139406c070e0a34486e5072b',18],
  'DAIes': ['0xcb92c8d49ec01b92f2a766c7c3c9c501c45271e0', '0x974cf21396D4D29F8e63Ac07eCfcbaB51a739bc9',18],
  'bsDAI': ['0x407ff7d4760d3a81b4740d268eb04490c7dfe7f2', '0x83241490517384cb28382bdd4d1534ee54d9350f',18],
  ...
  'bsBUSD': ['0x8c9abb6c9d8d15ddb7ada2e50086e1050ab32688', '0x137BEc8c83740920ebc4f29f51C7B65b75Beec83',18],
});
...
export function joinWithAddress(symbol: string | null, addresses: Record<string, string>) {
  ...
  return addresses[symbol] ? {symbol, address: addresses[symbol][0], oAddress: addresses[symbol][1], decimals: addresses[symbol][2]} : null;
}
