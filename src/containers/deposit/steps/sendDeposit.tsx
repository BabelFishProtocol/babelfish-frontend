...
export const SendDeposit = ({
  ...
  useEffect(() => {
    ...
    getTokenBalance(
      web3,
      tokenOnNetwork.oAddress || tokenOnNetwork.address,
    ).then(setAvailableTokenBalance);
  ...
  useEffect(() => {
    ...
    bridgeFees(web3, network, true).then(setBridgeFee);
    ...
    <>
      <div className="row px-5 py-4 justify-content-between">
        <div className="col-5">
          ...
          {valueSelectedToken &&
            tokenOnNetwork &&
            valueAvailableTokenBalance !== undefined && (
              <InputSubtext>
                Available Balance:{' '}
                {formatCurrencyAmount({
      ...
      <div className="row px-5 py-4 justify-content-between">
        ...
        <div className="col-5">
          <ButtonPrimary
            ...
            className="w-100"
            disabled={
              !(web3 && tokenOnNetwork && valueAmount) || valueIsDoingAction
            }
            onClick={() => {
              if (web3 && tokenOnNetwork && valueSelectedToken && valueAmount) {
                setIsDoingAction(true);
                deposit(web3, network, valueSelectedToken, valueAmount)
                  .then(onSubmit)
                  .catch()
                  .then(() => {
